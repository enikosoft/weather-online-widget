...
export const TemperatureIcon = (props: IconBaseProps) => {
  ...
  return (
    <Icon>
      ...
      >
        <g>
          <path
            d="M159.845,147.251V34.744C159.845,15.586,144.255,0,125.093,0c-19.159,0-34.746,15.586-34.746,34.744v112.506
		...
		C167.46,216.185,148.454,235.189,125.093,235.189z"
          />
          <path
            d="M132.595,169.042V69.924c0-4.142-3.357-7.5-7.5-7.5s-7.5,3.358-7.5,7.5v99.118c-10.104,3.183-17.43,12.622-17.43,23.783
